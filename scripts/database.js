var surgery_db = [
	...
	{name: 'Трансфузія. Поняття про групу та резус-фактор крові, методи їх визначення.', keys: 'перливання, трансфузія, гемотрансфузія', tags: '', status: ''},
	{name: 'Остеомієліт. Принципи місцевого та загального лікування хронічного остеомієліту з норицями.', keys: '', tags: '', status: ''},
	{name: 'Роль фельдшера в транспортуванні та інтенсивній терапії хворих з травматичним шоком. Зміст протишокових заходів в умовах військових дій та екстремальних ситуацій.', keys: 'травм шок', tags: '', status: ''},
	{name: 'Уявлення про некроз. Причини. Суха та волога гангрена. Місцеві й загальні прояви. Профілактика та лікування, догляд за хворими після операції.', keys: 'некроз, змертвіння, гангрени', tags: '', status: ''},
	...
	{name: 'Кровозамінні рідини. Показання до їх застосування.', keys: 'кровозамінники', tags: '', status: ''},
	...
	{name: 'Особливості та види місцевої анестезії. Медикаменти, які застосовуються для місцевої анестезії. Місцева анестезія в практиці фельдшера.', keys: 'анестезія', tags: '', status: ''},
	{name: 'Відмороження. Класифікація відморожень за ступенем ушкодження. Клінічна картина.  Перша допомога та лікування відмороження.', keys: 'обмороження', tags: '', status: ''},

...
var pediatrics_db = [
	...
	{name: 'Асфіксія новонароджених Етіологія. Клінічна картина. Лікування. Догляд Профілактика', keys: '', tags: '', status: 'write'},
	{name: 'Пологові травми. Внутрішньочерепна родова травма. Етіологія. Клінічна картина Лікування. Догляд. Профілактика', keys: '', tags: '', status: 'write'},
	{name: 'Гіповітамінози. Рахіт. Етіологія. Клінічні прояви', keys: '', tags: '', status: 'write'},
	{name: 'Анатомо-фізіологічні особливості кісткової системи. Профілактика і лікування хворих на рахіт', keys: '', tags: '', status: 'write'},
	{name: 'Гіпокальціємічний синдром. Етіологія. Клінічні ознаки. Лікування. Профілактика', keys: '', tags: '', status: 'write'},
	{name: 'Гострі розлади травлення у дітей раннього віку. Етіологія. Клінічні прояви. Лікування. Профілактика. Догляд', keys: '', tags: '', status: 'write'},
	{name: 'Гіпотрофія. Етіологія. Клінічна картина. Лікування. Профілактика. Догляд', keys: '', tags: '', status: 'write'},
	{name: 'Аномалії конституції. Ексудативно-катаральний діатез. Етіологія. Клінічні ознаки Лікування. Профілактика. Догляд', keys: '', tags: '', status: 'write'},
	...
	{name: 'Фолікулярна ангіна. Етіологія. Клінічна картина. Лікування. Догляд. Профілактика', keys: '', tags: '', status: 'write'},
	{name: 'Хронічний тонзиліт. Етіологія. Клінічні прояви. Лікування. Профілактика Диспансерне спостереження', keys: '', tags: '', status: 'write'},

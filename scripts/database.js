...
var pediatrics_db = [
	...
	{name: 'Гіпотиреоз. Етіологія. Клінічні прояви. Лікування. Прогноз', keys: '', tags: '', status: ''},
	{name: 'Імунопрофілактика інфекційних хвороб. Календар профілактичних щеплень', keys: '', tags: '', status: ''},
	{name: 'Грип. Етіологія. Клінічні ознаки. Лікування. Профілактика. Догляд', keys: '', tags: '', status: ''},
	{name: 'Аденовірусна інфекція. Етіологія. Клінічні ознаки. Лікування. Профілактика Догляд', keys: '', tags: '', status: ''},
	{name: 'Туберкульоз. Характеристика. Етіологія. Віраж. Специфічна профілактика', keys: '', tags: '', status: ''},
	{name: 'Рання туберкульозна інтоксикація. Етіологія. Клінічна картина. Лікування. Неспецифічна профілактика туберкульозу', keys: '', tags: '', status: ''},
	{name: 'Первинний туберкульозний комплекс. Туберкульоз внутрішньогрудних лімфатичних вузлів. Етіологія. Клінічні ознаки. Туберкулінодіагностика', keys: '', tags: '', status: ''},
	{name: 'Дифтерія. Характеристика. Дифтерія мигдаликів. Етіологія. Епідеміологія. Клінічна картина. Ускладнення. Лікування. Заходи в осередку інфекції', keys: '', tags: '', status: ''},
	{name: 'Дифтерія гортані. Етіологія. Епідеміологія. Клінічні прояви. Лікування. Заходи в осередку інфекції', keys: '', tags: '', status: ''},

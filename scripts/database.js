...
var obstetrics_db = [
	{name: 'Гестози вагітних: поняття, класифікація.', keys: '', tags: 'акушерство', status: ''},
	{name: 'Гестози першої половини вагітності: клінічна картина, принцвання.', keys: '', tags: 'акушерство', status: ''},
	{name: 'Гестози другої половини вагітності: класифікація, діагностичні критерії. ', keys: '', tags: 'акушерство', status: ''},
	{name: 'Прееклампсія легкого та середнього ступеня тяжкості: тактика, принципи лікування. ', keys: '', tags: 'акушерство', status: ''},
	{name: 'Тяжкі форми пізнього гестозу вагітних: тактика, перша допомога. ', keys: '', tags: 'акушерство', status: ''},
	{name: 'Профілактика гестозів вагітних. ', keys: '', tags: 'акушерство', status: ''},
	{name: 'Ведення вагітності та пологів при серцево-судинній патології.', keys: '', tags: 'акушерство', status: ''},
	{name: 'Хвороби нирок і вагітність. ', keys: '', tags: 'акушерство', status: ''},
	{name: 'Ізосерологічна несумісність крові матері та плода за резус-фактором та системою AB0; особливості ведення вагітності та пологів.', keys: '', tags: 'акушерство', status: ''},
	{name: 'Інфекційні захворювання і вагітність (TORCH) — особливості ведення вагітності і пологів.', keys: '', tags: 'акушерство', status: ''},
	{name: 'Невиношування вагітності: причини мимовільного аборту, стадії розвитку, профілактика. Тактика.', keys: '', tags: 'акушерство', status: ''},
	{name: 'Передчасні пологи, особливості ведення.', keys: '', tags: 'акушерство', status: ''},
	{name: 'Переношування вагітності: діагностика, тактика фельдшера, особливості ведення пологів. Ознаки переношування у плода.', keys: '', tags: 'акушерство', status: ''},
	{name: 'Передлежання плаценти: клінічна картина, діагностика, тактика фельдшера. ', keys: '', tags: 'акушерство', status: ''},
	...
	{name: 'Багатоплідна вагітність: види, діагностика, ускладнення, тактика ведення пологів. ', keys: '', tags: 'акушерство', status: ''},
	{name: 'Патологія послідового періоду, ведення послідового періоду. ', keys: '', tags: 'акушерство', status: ''},
	{name: 'Кровотечі в ранній післяпологовий період: причини, перша допомога. ', keys: '', tags: 'акушерство', status: ''},
	{name: 'Розриви шийки матки, піхви та промежини: причини, діагностика, тактика. ', keys: '', tags: 'акушерство', status: ''},
	{name: 'Розрив матки: класифікація, причини, клінічна картина загрози розриву матки та розриву матки, що стався. Тактика фельдшера.', keys: '', tags: 'акушерство', status: ''},
	{name: 'Післяпологові септичні захворювання: класифікація, причини, клінічна картина, принципи лікування.', keys: '', tags: 'акушерство', status: ''},
	{name: 'Акушерські операції: класифікація, показання та умови для виконання розроджувальних операцій.', keys: '', tags: 'акушерство', status: ''},
	{name: 'Особливості та значення анамнезу в гінекології, методика збирання анамнезу.', keys: '', tags: 'гінекологія', status: ''},
	{name: 'Методика і значення гінекологічного дослідження.', keys: '', tags: 'гінекологія', status: ''},
	{name: 'Додаткові методи дослідження в гінекології (інструментальні).', keys: '', tags: 'гінекологія', status: ''},
	{name: 'Піхвові мазки: види, техніка взяття.', keys: '', tags: 'гінекологія', status: ''},
	{name: 'Аномалії жіночих статевих органів: причини виникнення, клінічні прояви, діагностика, профілактика. ', keys: '', tags: 'гінекологія', status: ''},
	{name: 'Неправильні положення матки: причини, клінічні прояви, діагностика, профілактика.', keys: '', tags: 'гінекологія', status: ''},
	{name: 'Порушення менструального циклу (за типом дисфункційних маткових кровотеч): етіологія, клінічні прояви, діагностика, профілактика.', keys: '', tags: 'гінекологія', status: ''},
	{name: 'Порушення менструального циклу (за типом аменореї): етіологія, клінічні прояви, діагностика, профілактика. ', keys: '', tags: 'гінекологія', status: ''},
	{name: 'Запальні захворювання жіночих статевих органів (загальні дані). ', keys: '', tags: 'гінекологія', status: ''},
	{name: 'Трихомоніаз. ', keys: '', tags: 'гінекологія', status: ''},
	...
	{name: 'Пухлини. Характеристика злоякісних і доброякісних пухлин. Онкологічна служба в Україні. ', keys: '', tags: 'гінекологія', status: ''},
	...
	{name: 'Доброякісні пухлини ясчників: клінічна картина, діагностика, лікування. ', keys: '', tags: 'гінекологія', status: ''},
	{name: 'Злоякісні пухлини шийки матки: стадії поширення, клінічна картина, діагностика, значення біопсії, принципи комбінованого лікування.', keys: '', tags: 'гінекологія', status: ''},
	{name: 'Рак тіла матки: значення діагностичного вишкрібання, клінічна картина, принципи лікування.', keys: '', tags: 'гінекологія', status: ''},
	{name: 'Злоякісні новоутворення яєчників: стадії поширення, діагностика, принципи лікування. ', keys: '', tags: 'гінекологія', status: ''},
	{name: 'Травми жіночих статевих органів (ушкодження, нориці): етіологія, клінічна картина, лікування, діагностика, профілактика.', keys: '', tags: 'гінекологія', status: ''},
	{name: 'Позаматкова вагітність: причини, клінічна картина, діагностика, лікування, невідкладна допомога. ', keys: '', tags: 'гінекологія', status: ''},
	{name: 'Апоплексія яєчників, перекручування ніжки кісти та кістоми яєчника: клінічна картина, діагностика, невідкладна допомога. ', keys: '', tags: 'гінекологія', status: ''},
	{name: 'Хірургічне лікування в гінекології: підготовка хворих до операції, догляд за післяопераційними хворими. ', keys: '', tags: 'гінекологія', status: ''},
	{name: 'Види інструктажів з охорони праці. ', keys: '', tags: 'гінекологія', status: ''},
	{name: 'Інфекційна безпека та інфекційний контроль. ', keys: '', tags: 'гінекологія', status: ''},
	{name: 'Індивідуальні засоби захисту медичного персоналу в гінекології.', keys: '', tags: 'гінекологія', status: ''},

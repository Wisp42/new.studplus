...
var therapy_db = [
	{name: 'Історія розвитку внутрішньої медицини в Україні.', keys: '', tags: '', status: ''},
	...
	{name: 'Пневмоконіоз. Визначення, етіологія, види, основні клінічні симптоми, ускладнення, лікування, профілактика.', keys: '', tags: '', status: ''},
	{name: 'Легеневе серце. Визначення, причини розвитку, патогенез. Основні клінічні симптоми, діагностика, профілактика, лікування, догляд за пацієнтами.', keys: '', tags: '', status: ''},
	{name: 'Ревматизм. Етіологія, патогенез, клінічна класифікація. Позасерцеві форми ревматизму та їх основні клінічні ознаки.', keys: '', tags: '', status: ''},
	{name: 'Ревмокардит. Роль вогнищевої інфекції у виникненні ревмокардиту. Клінічні симптоми, прогноз, діагностика ревматизму.', keys: '', tags: '', status: ''},
	{name: 'Комплексне лікування хворих на ревматизм. Роль диспансерного спостереження, профілактика захворювання та його загострень. Прогноз захворювання, догляд за пацієнтами.', keys: '', tags: '', status: ''},
	{name: 'Набуті вади серця. Визначення, види, причини розвитку. Компенсація і декомпенсація. Вади серця та вагітність. Принципи лікування пацієнтів з вадами серця.', keys: '', tags: '', status: ''},
	{name: 'Мітральні вади серця (недостатність і стеноз). Етіологія, основні клінічні симптоми, лікування, догляд за пацієнтами.', keys: '', tags: '', status: ''},
	{name: 'Аортальні вади (недостатність і стеноз). Етіологія, основні клінічні симптоми, лікування, догляд за пацієнтами.', keys: '', tags: '', status: ''},
	{name: 'Бактеріальний ендокардит. Етіологія, клінічні симптоми, діагностика, лікування. Догляд за пацієнтами, прогноз.', keys: '', tags: '', status: ''},
	...
	{name: 'Інфаркт міокарда. Визначення, причини, які зумовлюють захворювання, механізм його розвитку. Варіанти перебігу. Ускладнення інфаркту міокарда.', keys: '', tags: '', status: ''},
	...
	{name: 'Гостра ниркова недостатність. Причини, основні клінічні симптоми, діагностика. Прогноз, лікування, догляд за пацієнтами, профілактика.', keys: '', tags: '', status: ''},
	{name: 'Хронічна ниркова недостатність. Етіологія, патогенез. Основні клінічні ознаки, діагностика. Прогноз, лікування. Догляд за пацієнтами, профілактика.', keys: '', tags: '', status: ''},
	{name: 'Нироковокам’яна хвороба. Етіологія, патогенез. Основні клінічні ознаки ниркової коліки. Діагностика, зняття нападу ниркової коліки.', keys: '', tags: '', status: ''},
